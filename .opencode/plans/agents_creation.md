...
## Goal
Create a developer/agent guide file `AGENTS.md` in the project root to assist future coding agents.

## Source Analysis
- **Project Type:** Python CLI (Backend) + Next.js (Frontend).
- **Locations:**
    - Root: `/Users/agitated_buddha/src2.0/analyser`
    - CLI Entry: `cli.py`
    - Tests: `tests/` (pytest)
    - Frontend: `frontend/` (npm/next)
- **Constraints:**
    - Python 3.10+
    - Strict `pathlib` usage.
    - PEP 8 and Type Hints mandatory.

## Proposed Content for AGENTS.md
...
## Verification Steps
1.  Review content against `cli.py` and `pyproject.toml`.
2.  Ensure correct test command syntax.
3.  Check frontend commands in `package.json`.
